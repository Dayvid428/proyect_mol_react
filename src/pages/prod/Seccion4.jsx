    ...
    <Box sx={{ mt: 8, px:4 }}>
      <div className='seccion1-contenido' >
        ...
        <div className='contenido-flex'>
          <p>
          Respondemos a las necesidades del sector industrial con productos de caucho versátiles y resistentes. Proveemos bandas transportadoras, juntas de sellado y piezas a medida que cumplen con los estándares más exigentes.
          </p>
